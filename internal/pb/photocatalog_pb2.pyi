...
class PhotoUploadRequest(_message.Message):
    __slots__ = ("description", "content")
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    CONTENT_FIELD_NUMBER: _ClassVar[int]
    description: str
...
class UploadResponse(_message.Message):
    __slots__ = ("success", "message", "uploaded_count")
    ...
    message: str
    uploaded_count: int
    def __init__(self, success: bool = ..., message: _Optional[str] = ..., uploaded_count: _Optional[int] = ...) -> None: ...
