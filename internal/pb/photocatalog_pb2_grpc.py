...
class PhotoCatalogServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadPhotos = channel.stream_unary(
                '/PhotoCatalogService/UploadPhotos',
                request_serializer=photocatalog__pb2.PhotoUploadRequest.SerializeToString,
                response_deserializer=photocatalog__pb2.UploadResponse.FromString,
                _registered_method=True)
...
def add_PhotoCatalogServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UploadPhotos': grpc.stream_unary_rpc_method_handler(
                    ...
                    request_deserializer=photocatalog__pb2.PhotoUploadRequest.FromString,
                    response_serializer=photocatalog__pb2.UploadResponse.SerializeToString,
            ),
    }
...
class PhotoCatalogService(object):
    ...
    def UploadPhotos(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            target,
            '/PhotoCatalogService/UploadPhotos',
            photocatalog__pb2.PhotoUploadRequest.SerializeToString,
            photocatalog__pb2.UploadResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
